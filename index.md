...
- stringsAsFactors 預設是`True`, 讓讀入的字串用Factor儲存，那麼資料就會轉為整數儲存與對照表
- header 預設是`False`，表示第一行是不是表格標頭，輸出的dataframe欄位名的colnames
...
[https://www.esunfhc.com.tw/hireexam/NoticeRecruitment.asp](https://www.esunfhc.com.tw/hireexam/NoticeRecruitment.asp)
